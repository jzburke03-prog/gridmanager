...
REGIONS = [
    ...
    Region("SPP", "SPP (Great Plains)", "Wind-record grid, thin firm capacity"),
]
...
SCENARIOS = [
    ...
    Scenario(
        "spp_2021", "Great Plains Deep Freeze", "SPP", _dt.date(2021, 2, 15), "expert",
        "SPP — 15 Feb 2021",
...
def make_scenario(scenario: Scenario) -> RunConfig:
    ...
    if eia_day:
        return _build_from_eia(eia_day, diff, scenario.title, scenario.region_code,
